...
def main():
    ...
    game_name = config['Settings']['game_name'] # Gets the game name from the configuration file
    ...
    functions.generate_manifest(local_game_directory, game_name, game_version, release_date, base_url) # Generates the manifest file for the game
